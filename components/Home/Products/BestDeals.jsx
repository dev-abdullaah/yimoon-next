// components/Home/Products/BestDeals.jsx
'use client';
...
const BestDeals = () => {
    ...
    // Fetch Best Deals Product data with proper API parameters
    const { data: bestDealsData, isLoading, isError } = useQuery({
        queryKey: ['bestDeals'],
        queryFn: async () => {
            ...
            formData.append('condition', "featured LIKE '12%'");
    ...
    const products = bestDealsData ? transformProductData(bestDealsData) : [];
    ...
    if (isLoading) {
        return (
            <div className="relative">
                <div className="daily_deals_container sm:rounded-default -mx-5 px-5 py-2 sm:mx-0 md:px-7 lg:py-5 2xl:px-11">
                    <div className="flex items-end justify-between lg:px-14 xl:items-center">
                        <div className="flex flex-col-reverse text-white xl:flex-row xl:items-center">
            ...
            <div className="daily_deals_container sm:rounded-default -mx-5 px-5 py-2 sm:mx-0 md:px-7 lg:py-5 2xl:px-11">
                <div className="flex items-end justify-between lg:px-14 xl:items-center">
                    ...
                    <Link
                        ...
                        href="/featured?featuredId=12"
                    >
                        <h3 className="text-sm font-semibold md:text-base xl:text-xl flex items-center md:gap-1">
                            See More<span className="sr-only">Best Deals Products</span>
                            <RightArrowLgIcon />
                        </h3>
                    </Link>
                </div>
