// components/Home/Products/ExtraDiscount.jsx
'use client';
...
const ExtraDiscount = () => {
    ...
    // Fetch Extra Discount Product data
    const { data: extraDiscountData, isLoading, isError } = useQuery({
        queryKey: ['extraDiscount'],
        queryFn: async () => {
            ...
            formData.append('condition', "featured LIKE '11%'");
    ...
    const products = extraDiscountData ? transformProductData(extraDiscountData) : [];
    ...
    if (isLoading) {
        return (
            <div className="relative">
                <div className="sm:rounded-default -mx-5 px-5 py-6 sm:mx-0 md:px-7 lg:py-8 2xl:px-11 bg-dark-primary text-white">
