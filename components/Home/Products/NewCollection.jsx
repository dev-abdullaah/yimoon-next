// components/Home/Products/NewCollection.jsx
'use client';
...
const NewCollection = () => {
    ...
    // Fetch New Collection Product data
    const { data: newCollectionData, isLoading, isError } = useQuery({
        ...
        queryFn: async () => {
            ...
            formData.append('condition', "featured LIKE '13%'");
    ...
    const products = newCollectionData ? transformProductData(newCollectionData) : [];
            ...
            <div className="sm:rounded-default -mx-5 px-5 py-6 sm:mx-0 md:px-7 lg:py-8 2xl:px-11 bg-slate-100 text-dark">
                <div className="flex items-center justify-between lg:px-14">
                    ...
                    <Link
                        ...
                        href="/featured?featuredId=13"
                    >
                        <h3 className="text-sm font-semibold md:text-base xl:text-xl flex items-center md:gap-1">
                            See More<span className="sr-only">New Collection Products</span>
                            <RightArrowLgIcon />
                        </h3>
                    </Link>
                </div>
